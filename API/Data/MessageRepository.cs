...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            {
                "Inbox" => query.Where(u => u.Recipient.UserName == messageParams.Username && !u.RecipentDeleted),
                "Outbox" => query.Where(u => u.Sender.UserName == messageParams.Username && !u.SenderDeleted),
                _ => query.Where(u => u.Recipient.UserName == messageParams.Username && u.DateRead == null && u.RecipentDeleted) // "Unread" case
            };
